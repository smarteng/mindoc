...
#RUN mkdir -p /go/src/github.com/smarteng/ && cd /go/src/github.com/smarteng/ && git clone https://github.com/smarteng/mindoc.git && cd mindoc

ADD . /go/src/github.com/smarteng/mindoc

WORKDIR /go/src/github.com/smarteng/mindoc
...
ADD start.sh /go/src/github.com/smarteng/mindoc
...
COPY --from=build /go/src/github.com/smarteng/mindoc /mindoc
